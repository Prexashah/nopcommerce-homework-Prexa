Feature: Nopcommerce Registration
  ...
  Scenario Outline:  I should not be able to register with invalid data on mandatory field(*) of registration page
    ...
    Examples:
      ...
      | Rohan      | bakshi    | " "              | 456897   | 456897           | please enter valid emil                    |
      ...
      | Rohan      | bakshi    | bakshi@gmail.com | 456897   | 45672            | password and confirm password do not match |
      | Rohan      | bakshi    | bakshi@gmailcom  | 45689    | " "              | minimum 6 character password is required   |
  ...
  Scenario:   I should be able to check and uncheck the Newsletter bo on Options section
